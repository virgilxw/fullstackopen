...
let bodyToken = morgan.token('body', req => {
    return JSON.stringify(req.body)
})

let morganArg = ":method :url :res[content-length] :status :response-time[2] ms :body "

app.use(morgan(morganArg, { stream: accessLogStream }))

app.use(morgan(morganArg))
